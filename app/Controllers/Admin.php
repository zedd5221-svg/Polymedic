...
class Admin extends BaseController
{
    ...
    public function approveAppointment($id)
    {
        ...
        \App\Models\NotificationModel::notify(
            'appointment',
            'Appointment Approved: ' . $appointment['reference_number'],
            'Appointment for ' . $appointment['full_name'] . ' has been approved.',
            $id,
            site_url('admin/appointment/view/' . $id)
        );
    ...
    public function cancelAppointment($id)
    {
        ...
        \App\Models\NotificationModel::notify(
            'appointment',
            'Appointment Cancelled: ' . $appointment['reference_number'],
            'Appointment for ' . $appointment['full_name'] . ' was cancelled.',
            $id,
            site_url('admin/appointment/view/' . $id)
        );
    ...
    public function completeAppointment($id)
    {
        ...
        \App\Models\NotificationModel::notify(
            'appointment',
            'Appointment Completed: ' . $appointment['reference_number'],
            'Appointment for ' . $appointment['full_name'] . ' marked as completed.',
            $id,
            site_url('admin/appointment/view/' . $id)
        );
