...
<div class="page-header">
    <div class="header-actions">
        <a href="/polymedic/public/admin/appointments" class="btn btn-secondary">
                ...
                <div class="profile-row">
                    ...
                    <div class="profile-info">
                        ...
                        <div class="profile-meta">
                            <span><i class="bi bi-gender-ambiguous"></i> <?= $appointment['gender'] ?></span>
                            <span><i class="bi bi-cake2"></i> <?= $appointment['age'] ?> years old</span>
            ...
            <div class="chart-body">
                <?php if (!empty($lab_services) || !empty($xray_services)): ?>
                    <div class="row g-2">
                        ...
                        <div class="col-md-6">
                            <h6 class="fw-bold text-primary"><i class="bi bi-droplet me-1"></i> Laboratory Tests</h6>
                            <ul class="service-list">
                                <?php foreach ($lab_services as $service): ?>
                                    <li><i class="bi bi-check-circle-fill text-success me-1"></i> <?= $service ?></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        <?php endif; ?>
                ...
                <?php if ($appointment['other_requests']): ?>
                    <div class="mt-3 p-3 bg-light rounded-3">
                        ...
                        <p class="mb-0 text-muted"><?= $appointment['other_requests'] ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="chart-body">
                <div class="action-buttons">
                    <?php if ($appointment['status'] == 'pending' || $appointment['status'] == 'late'): ?>
                        <a href="/polymedic/public/admin/appointment/approve/<?= $appointment['id'] ?>" 
                           class="btn btn-success btn-action w-100 mb-2" 
                           onclick="return confirm('Approve this appointment?')">
                            <i class="bi bi-check-circle me-2"></i>Approve
                        </a>
                        <a href="/polymedic/public/admin/appointment/cancel/<?= $appointment['id'] ?>" 
                           class="btn btn-danger btn-action w-100 mb-2" 
                           onclick="return confirm('Cancel this appointment?')">
                            <i class="bi bi-x-circle me-2"></i>Cancel
                        </a>
                        <a href="/polymedic/public/admin/appointment/delete/<?= $appointment['id'] ?>" 
                           class="btn btn-outline-danger btn-action w-100" 
                           onclick="return confirm('⚠️ Are you sure you want to permanently delete this appointment?\n\nReference: <?= $appointment['reference_number'] ?>\nPatient: <?= $appointment['full_name'] ?>\n\nThis action cannot be undone!')">
                            <i class="bi bi-trash3 me-2"></i>Delete
                        </a>
                    <?php elseif ($appointment['status'] == 'approved'): ?>
                        <a href="/polymedic/public/admin/appointment/complete/<?= $appointment['id'] ?>" 
        ...
        <div class="chart-card mt-3">
            ...
            <div class="chart-body">
                <div class="quick-actions">
                    <a href="mailto:<?= $appointment['email'] ?>" class="action-btn">
                        <i class="bi bi-envelope"></i>
                        Send Email
                    </a>
                    <a href="tel:<?= $appointment['phone'] ?>" class="action-btn">
...
.btn-secondary:hover {
    ...
    box-shadow: 0 4px 12px rgba(1, 72, 202, 0.1);
    text-decoration: none;
}
...
.profile-avatar {
    ...
    height: 56px;
    border-radius: 50%;
    background: linear-gradient(135deg, #0148ca, #0a2b4e);
    color: white;
    display: flex;
    align-items: center;
    justify-content: center;
...
.timeline-dot.bg-primary { background: #0148ca; }
