...
<?php
$notifBase = $notif_base ?? 'medtech/notifications';
    ...
    <section class="nc-panel" aria-label="Notifications">
        ...
        <?php if (!empty($notifications)): ?>
            ...
            <div class="nc-list" id="ncList">
                ...
                foreach ($notifications as $notif):
                    ...
                    /* MedTech: gender applies to lab requests once those
                       rows carry reference_gender. Until then, the tile
                       fallback is used, which is fine. */
                    $showAvatar = ($gender !== null && in_array($type, ['appointment', 'lab'], true));
        ...
        <?php else: ?>
            ...
            <div class="nc-empty">
                ...
                <p>New laboratory requests will show up here.</p>
            </div>
