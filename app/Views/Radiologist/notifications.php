...
<?php
$notifBase = $notif_base ?? 'radiologist/notifications';
    ...
    <section class="nc-panel" aria-label="Notifications">
        ...
        <?php if (!empty($notifications)): ?>
            ...
            <div class="nc-list" id="ncList">
                ...
                foreach ($notifications as $notif):
                    ...
                    /* Radiologist: gender applies to x-ray examinations
                       once those rows carry reference_gender. Until then,
                       the tile fallback is used, which is fine. */
                    $showAvatar = ($gender !== null && in_array($type, ['appointment', 'xray'], true));
        ...
        <?php else: ?>
            ...
            <div class="nc-empty">
                ...
                <p>New X-ray examinations assigned to you will show up here.</p>
            </div>
