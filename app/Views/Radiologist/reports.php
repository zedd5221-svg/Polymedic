...
<div class="reports-container">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">View radiology statistics and reports</p>
        </div>
    </div>
                    ...
                    <?php if (!empty($monthlyStats)): ?>
                        <?php foreach ($monthlyStats as $month => $stats): ?>
                            <tr>
                                ...
                                <td><span class="badge-status processing"><?= $stats['processing'] ?? 0 ?></span></td>
...
.stat-icon.success { background: #e8f5e9; color: #28a745; }
